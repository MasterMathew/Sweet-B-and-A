...
if imperial_time == true then
	date_day = wibox.widget{
		font = beautiful.font_name .. "bold 10",
		format = helpers.colorize_text("%A, %B %d, %Y", beautiful.xforeground),
		align = "center",
		valign = "center",
	...
	date_day = wibox.widget{
		font = beautiful.font_name .. "bold 10",
		format = helpers.colorize_text("%A, %d %B, %Y", beautiful.xforeground),
		align = "center",
		valign = "center",
		widget = wibox.widget.textclock
	}
