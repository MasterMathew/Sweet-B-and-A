...
awful.screen.connect_for_each_screen(function(s)
  ...
  local control_center_row_three =
    wibox.widget {
  ...
  local cpu_box = create_boxed_widget(cpu_details, dpi(50), dpi(140), beautiful.control_center_widget_radius, beautiful.control_center_widget_bg)
  ...
  local ram_box = create_boxed_widget(ram_details, dpi(50), dpi(140), beautiful.control_center_widget_radius, beautiful.control_center_widget_bg)
  ...
  local temp_box = create_boxed_widget(temp_details, dpi(50), dpi(140), beautiful.control_center_widget_radius, beautiful.control_center_widget_bg)
  ...
  control_center.y = cont_center_ypos

  -- rubato
  local slide = rubato.timed {
    pos = dpi(cont_center_hidepos),
    rate = 60,
    intro = 0.2,
    duration = 0.6,
  ...
  control_center_show = function()
    ...
    slide:set(cont_center_shownpos)
    control_center_status = false
  end

  control_center_hide = function()
    slide:set(cont_center_hidepos)
